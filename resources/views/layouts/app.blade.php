...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Favicon -->
        <link href="{{ URL::asset('public/argon/img/brand/favicon.png') }}" rel="icon" type="image/png">
        <!-- Fonts -->
    ...
    <!-- End Google Tag Manager -->
        <!-- Icons -->
        <link href="{{ URL::asset('public/argon/vendor/nucleo/css/nucleo.css') }}" rel="stylesheet">
        <link href="{{ URL::asset('public/argon/vendor/@fortawesome/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
        <!-- Argon CSS -->
        <link type="text/css" href="{{ URL::asset('public/argon/css/argon.css?v=1.0.0') }}" rel="stylesheet">
