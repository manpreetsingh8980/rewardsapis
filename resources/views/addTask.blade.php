                        ...
                        <form role="form" method="POST" action="{{ route('admin.submitTask') }}" enctype="multipart/form-data">
							...
							<div class="form-group{{ $errors->has('repeat') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
									...
									<input class="form-control{{ $errors->has('repeat') ? ' is-invalid' : '' }}" placeholder="{{ __('Repeat') }}" type="number" name="repeat" value="{{ old('repeat') }}" required>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary mt-4">{{ __('Add New Task') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
